...
export const Sidebar = ({ showSidebar, setShowSidebar }) => {
  ...
  return (
    <nav className={`top-0 left-0 w-[65vw] sm:max-w-xs bg-slate-100 dark:bg-zinc-900 pt-20 px-8 text-black fixed h-full transition-transform duration-300 z-40 rounded-tr-3xl rounded-br-3xl ${
